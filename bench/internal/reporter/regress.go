...
// RegressionTolerance is the default band for steady-throughput regression on
// shared CI runners (high variance when eight benchmark tools compete for CPU).
const RegressionTolerance = 0.35
