...
export const SEO_DOCS: SeoDoc[] = [
  ...
  { slug: 'docs-events-sdk', title: 'TypeScript SDK', description: 'ChangeEvent wire types and runtime guards for @kaptanto/events — install from source until npm publish.' },
  { slug: 'docs-python-sdk', title: 'Python SDK', description: 'pydantic ChangeEvent models and an httpx SSE client — install from source until PyPI publish.' },
  { slug: 'docs-mastra', title: 'Mastra Integration', description: 'Trigger Mastra workflows from real-time database changes — install @kaptanto/mastra from source until npm publish.' },
